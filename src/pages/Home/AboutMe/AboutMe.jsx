    ...
    return (
        <div className="p-6 w-11/12 mx-auto shadow-lg rounded-lg relative mb-10 text-black" id="about-me">
            ...
            <motion.div
                        ...
                        />
            <h1 className="text-3xl font-bold mb-6 p-1">About Me</h1>
            ...
            <div className="mb-6">
                <h2 className="text-2xl font-semibold mb-2 p-1">My Interests</h2>
                <p className='p-1'>
                ...
                <div>
                    <h3 className="text-xl font-bold mb-2 w-full mx-auto text-center p-1 mt-2">Gallery</h3>
                    <div className="w-11/12 mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 my-4 rounded-sm relative">
                    <motion.div
                            className="absolute inset-0 -z-10"
                            animate={{
                                boxShadow: [
