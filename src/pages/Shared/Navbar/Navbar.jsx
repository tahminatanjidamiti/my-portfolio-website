        ...
        <div className='sticky top-0 z-50 backdrop-blur-sm bg-gradient-to-tl from-sky-300 via-blue-400 to-indigo-900 to-90% bg-opacity-20 py-4'>
            <div className="navbar bg-sky-300 rounded-lg w-11/12 mx-auto text-black">
                <div className="navbar-start">
                    ...
                    <div className='flex items-center gap-1'><img className='w-12 border border-amber-500 h-12 rounded-full object-center' src="https://i.ibb.co.com/snV9cqG/Untitled-design.png" alt="Logo name!" /> <i className='font-extrabold'>Tahmina Tanjida</i></div>
                </div>
                ...
                <label className="flex cursor-pointer gap-2">
                    ...
                    <img className='w-12 h-12 rounded-full' src="https://i.ibb.co.com/gbzDM6wB/miti-removebg-preview-4.png" alt="Picture!" />
                </div>
            </div>
        </div>
    );
